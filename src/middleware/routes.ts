...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/v1/users',
            authenticateMiddleware([{"features":["users.list"]}]),
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.getAll)),

            async function UsersController_getAll(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/api/v1/users/current',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.getCurrent)),

            async function UsersController_getCurrent(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/api/v1/auth',
            ...
            const args = {
                    command: {"in":"body","name":"command","required":true,"ref":"AuthenticationLoginRequest"},
            };
